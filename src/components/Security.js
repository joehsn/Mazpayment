            ...
            <Row className='justify-content-center'>
                ...
                <Row className='flex-column-reverse flex-md-row'>
                    <Col md={6} className='fs-4 mt-3 mt-md-0'>
                        <p className='pt-md-4 pe-md-5'>تم البناء بإعتبار أمن المعلومات هو الأساسي ليتوافق بشكل كامل مع معايير PCI DSS كموفر خدمة من المستوى الأول، والذي يعد المعيار الأمني الرئيسي في مجال تكنولوجيا المدفوعات حيث تضمن أن البيانات بالغة الأهمية آمنة دائماً.<br /><br />
