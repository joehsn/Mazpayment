        ...
        <Row>
            ...
            <Col className='px-md-5 px-3'>
                <Row className='justify-content-evenly text-primary'>
                    <Col md={2} xs={6} data-aos='fade-left' data-aos-delay="50">
                        <FaCcMastercard className='w-100 h-100' />
                    </Col>
                    <Col md={2} xs={6} data-aos='fade-left' data-aos-delay="100">
                        <FaCcVisa className='w-100 h-100' />
                    </Col>
                    <Col md={2} xs={6} data-aos='fade-left' data-aos-delay="150">
                        <FaCcPaypal className='w-100 h-100' />
                    </Col>
                    <Col md={2} xs={6} data-aos='fade-left' data-aos-delay="200">
                        <FaCcAmazonPay className='w-100 h-100' />
                    </Col>
                    <Col md={2} xs={6} data-aos='fade-left' data-aos-delay="250">
                        <FaCcApplePay className='w-100 h-100' />
                    </Col>
                    <Col md={2} xs={6} data-aos='fade-left' data-aos-delay="300" className='d-flex justify-content-center align-items-center'>
